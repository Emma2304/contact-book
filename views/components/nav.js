...
const createHomeNav = () => {
  ...
  navbar.innerHTML = `
    <div class="max-w-7xl h-16 mx-auto flex items-center px-4 justify-between">
            <h1 class="font-bold text-xl text-white">MyContact</h1>
...
const createNavContactos = () => {

  navbar.innerHTML = `
    <div class="max-w-7xl h-16 mx-auto flex items-center px-4 justify-between">
            <h1 class="font-bold text-xl text-white">Contacts</h1>
            ...
            <svg
             ...
             >
              ...
              <!-- menu movil  -->
              <div class="bg-slate-900/60 fixed top-16 right-0 left-0 bottom-0 items-center flex-col gap-4 hidden">
                <button id="close-btn" class="transition ease-in-out text-white font-bold hover:bg-indigo-800 py-2 px-4 rounded-lg">Cerrar sesion</button>
              </div>
        </div>
    `;
